    ...
    public function execute(Observer $observer)
    {
        ...
        */
        ...
        //if (strpos($_SERVER['REQUEST_URI'], 'order/cancel') !== false) 
		{
            ...
            //Getting Message
            $this->message          = $this->_helper->getCustomerSmsOnCancelled();

            //Getting Customer Notification value
            $this->enabled          = $this->_helper->isCustomerSmsIsEnabledOnCancelled();
            ...
            if ($this->enabled == 1) {
                ...
                if ($verificationResult == true) {
                    ...
                    if ($this->_helper->isAdminSmsIsEnabled()==1) {
                        ...
                        $this->message      = $this->_helper->getAdminSmsForOrderCancelled();
                        $this->message      = $this->_helper->manipulateSMS($this->message, $orderData);
                        $this->_helper->sendSms(
                            $this->username,
                            $this->password,
